...
\end{tabular}
\caption{Mean Average Precision for different SVM training sizes, 400 clusters}
\label{tbl:refOfTable}
\end{table}
\begin{table}[h!]
\centering
...
\end{tabular}
\caption{Mean Average Precision for different SVM training sizes, 800 clusters}
\label{tbl:refOfTable}
\end{table}
\begin{table}
\begin{tabular}{cccc}
...
\end{tabular}
\caption{Average precision per class for table 5}
\label{tbl:refOfTable}
\end{table}
...
\end{tabular}
\caption{Mean Average Precision for different vocabulary training sizes}
\label{tbl:refOfTable}
\end{table}
\begin{table}
\begin{tabular}{cccc}
